...
from danlp.download import download_dataset

# https://github.com/alexandrainst/danlp/blob/master/danlp/datasets/wiki_ann.py
...
def _wikiann_process_func(tmp_file_path: str, meta_info: dict, cache_dir: str = '.',
