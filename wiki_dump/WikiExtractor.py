#modified https://github.com/attardi/wikiextractor
...
def process_dump(input_file, template_file, out_file, file_size, file_compress,
    ...
    for line in input:
        ...
        if tag == 'page':
            ...
            timestamp1 = "Jan 01 00:00:01 2021"
            t1 = datetime.strptime(timestamp1, "%b %d %H:%M:%S %Y")
            t2 = datetime.strptime(m.group(3), "%Y-%m-%dT%H:%M:%SZ")
...
def reduce_process(output_queue, output):
    ...
    while True:
        if next_ordinal in ordering_buffer:
            ...
            # MIN_LENGTH = 2000  # average length of word is 4.7
            # MAX_LENGTH = 10000
            # l = len(next[1])
